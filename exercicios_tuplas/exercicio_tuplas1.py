...
print(f'Meu produto mais vendido no dia 21/08/2020 foi o {produto_mais_vendido} {capacidade_produto_mais_vendido} na cor {cor_produto_mais_vendido} com {qtde_produto_mais_vendido} unidades')
